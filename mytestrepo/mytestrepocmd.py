...
def main(args):
    ...
    :return: return value of :py:meth:`mytestrepo.runner.MytestrepoRunner.run`
    ...
    Invokes run() method on MytestrepoRunner

    """.format(version=mytestrepo.__version__)
    theargs = _parse_arguments(desc, args[1:])
    theargs.program = args[0]
    theargs.version = mytestrepo.__version__

    try:
        _setup_logging(theargs)
        return MytestrepoRunner(theargs.exitcode).run()
