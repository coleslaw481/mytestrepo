...
# -*- coding: utf-8 -*-
#
# mytestrepo documentation build configuration file, created by
...
init_file = os.path.join('..', 'mytestrepo', '__init__.py')
...
htmlhelp_basename = 'mytestrepodoc'
...
latex_documents = [
    (master_doc, 'mytestrepo.tex',
     u'My Test Repo Documentation',
